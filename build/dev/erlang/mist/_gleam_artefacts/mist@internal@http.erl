...
?DOC(false).
-spec add_date_header(gleam@http@response:response(ENE)) -> gleam@http@response:response(ENE).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(ENH)) -> gleam@http@response:response(ENH).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(ENK)) -> gleam@http@response:response(ENK).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(ENN)) -> gleam@http@response:response(ENN).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(ENS)) -> gleam@http@response:response(ENS)).
