...
-type pool(BQX, BQY) :: {pool,
        fun((glisten@internal@handler:loop_message(BQX), BQY, glisten@internal@handler:connection(BQX)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(BQX), BQY)),
        integer(),
        fun((glisten@internal@handler:connection(BQX)) -> {BQY,
            gleam@option:option(gleam@erlang@process:selector(BQX))}),
        gleam@option:option(fun((BQY) -> nil)),
        glisten@transport:transport()}.
