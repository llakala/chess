...
-file("src/directories.gleam", 247).
-spec main() -> {ok, binary()} | {error, nil}.
main() ->
    gleam_stdlib:print(<<"Current Platform: "/utf8>>),
    _ = gleam@io:debug(platform:os()),
    gleam_stdlib:println(<<"==="/utf8>>),
    gleam_stdlib:print(<<"Temp Directory: "/utf8>>),
    _ = gleam@io:debug(tmp_dir()),
    gleam_stdlib:print(<<"Home Directory: "/utf8>>),
    _ = gleam@io:debug(home_dir()),
    gleam_stdlib:print(<<"Cache Directory: "/utf8>>),
    _ = gleam@io:debug(cache_dir()),
    gleam_stdlib:print(<<"Config Directory: "/utf8>>),
    _ = gleam@io:debug(config_dir()),
    gleam_stdlib:print(<<"Config Directory (Local): "/utf8>>),
    _ = gleam@io:debug(config_local_dir()),
    gleam_stdlib:print(<<"Data Directory: "/utf8>>),
    _ = gleam@io:debug(data_dir()),
    gleam_stdlib:print(<<"Data Directory (Local): "/utf8>>),
    _ = gleam@io:debug(data_local_dir()),
    gleam_stdlib:print(<<"Executables Directory: "/utf8>>),
    _ = gleam@io:debug(executable_dir()),
    gleam_stdlib:print(<<"Preferences Directory: "/utf8>>),
    _ = gleam@io:debug(preference_dir()),
    gleam_stdlib:print(<<"Runtime Directory: "/utf8>>),
    _ = gleam@io:debug(runtime_dir()),
    gleam_stdlib:print(<<"State Directory: "/utf8>>),
